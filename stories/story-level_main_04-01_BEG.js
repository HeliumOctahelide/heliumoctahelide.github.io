var story = [
    ...
    [
        ...
        "playground.clearDialog();blocker.blocker({a:1, r:0, g:0, b:0, fadetime:0.6, block:true});playground.drawCharacter({fadetime:0});background.showImage({fadetime:0});voice.playSound({key:'d_gen_walk_n'});delay(0.6);playground.Decision({options:[['1'], '（敲门）']});",
        "predicate = ['1'];",
        ...
        "playground.drawCharacter({name:'char_002_amiya_1', focus:-1});playground.Decision({options:[['1'], '（沉默）']});",
        "predicate = ['1'];",
        ...
        "playground.drawDialog({name:'阿米娅',text:'......'});",
        "playground.drawCharacter({name:'char_002_amiya_4', focus:-1});playground.Decision({options:[['1', '2'], '......', '阿米娅......']});",
        "predicate = ['1', '2'];",
        ...
        "playground.drawCharacter({name:'char_003_kalts_1', focus:-1});playground.Decision({options:[['1', '2'], '请问，阿米娅的戒指是？', '......']});",
        "predicate = ['1'];",
