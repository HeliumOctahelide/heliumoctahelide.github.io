var story = [
    ...
    [
        ...
        "playground.clearDialog();playground.drawCharacter({});voice.playSound({key:'d_gen_rungeneral', volume:0.9});delay(2);playground.Decision({options:[['1', '2', '3'], '你要说什么？！', '......', '如果我也不相信罗德岛的话？']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1', '2', '3'], '正常的还是......']});",
        "predicate = ['1'];",
