var story = [
    ...
    [
        "background.showImage({image:'bg_hotel',screenadapt:'coverall', fadetime:1});playground.clearDialog();playground.drawCharacter({});delay(1);playground.Decision({options:[['1'], '原来是这样......']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1'], '不管怎么说，大家平安无事就好。']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1'], '市长的女儿？！']});",
        "predicate = ['1'];",
        ...
        "playground.clearDialog();blocker.blocker({a:1, r:0,g:0, b:0, fadetime:2, block:true});playground.drawCharacter({});background.showImage({image:'bg_hotel'});blocker.blocker({a:0, fadetime:2, block:true});playground.Decision({options:[['1', '2'], '火山爆发？！', '开玩笑吧？！']});",
        "predicate = ['1', '2'];",
