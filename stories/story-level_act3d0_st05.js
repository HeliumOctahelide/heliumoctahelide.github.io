var story = [
    ...
    [
        ...
        "playground.Decision({options:[['1', '2'], '抱歉。', '这身泳装很适合你，阿米娅。']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1'], '我们这次可能确实做得有些过火......']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1'], '其实，我们已经......']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1'], '......？可我们是......']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1'], '我知道了。']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1', '2', '3'], '（跟着阿米娅走）', '（向阿米娅泼水）', '（拉住阿米娅的手）']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1'], '......好的。']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1', '2', '3'], '那不是鲁莽。', '我并没有做太多的事情。', '你应该感谢的人是锡兰才对。']});",
        "predicate = ['1', '2', '3'];",
        ...
        "playground.Decision({options:[['1'], '为什么和我说这些？']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1', '2', '3'], '我是。', '我不是。', '谁知道呢。']});",
        "predicate = ['1', '2', '3'];",
        "playground.drawDialog({name:'赫尔曼',text:'对我来说，善良与否在很久以前就没有任何意义了，有的只有结果，有的只有这座城市。'});",
        "playground.Decision({options:[['1'], '为什么不告诉锡兰？']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1'], '那黑曜石节......']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1', '2', '3'], '你的目的是什么？', '你好，陌生人？', '要不要喝一杯？']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1', '2', '3'], '你不该替她做决定。', '时光无法倒流，她已经是现在这样。', '那真是对不起咯？']});",
        "predicate = ['1', '2', '3'];",
        ...
        "playground.Decision({options:[['1'], '要加入我们可不轻松。']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1', '2', '3'], '这就来！', '......', '我会好好盯着她的，放心吧。']});",
        "predicate = ['1', '2', '3'];",
