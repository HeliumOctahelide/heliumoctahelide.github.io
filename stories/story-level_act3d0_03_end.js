var story = [
    ...
    [
        ...
        "playground.Decision({options:[['1', '2'], '没问题。', '作业你要自己努力。']});",
        "predicate = ['1'];",
        ...
        "playground.Decision({options:[['1', '2', '3'], '微笑。', '鞠躬。', '跳舞。']});",
        "predicate = ['1', '2', '3'];",
        ...
        "voice.playSound({key:'d_gen_runsand', volume:0.7});playground.clearDialog();playground.drawCharacter({fadetime:1,block:true});delay(1);playground.Decision({options:[['1'], '竟然直接就跑开了。']});",
        "predicate = ['1'];",
