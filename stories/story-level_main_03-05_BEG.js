var story = [
    ...
    [
        ...
        "playground.drawCharacter({name:'char_002_amiya_4', name2:'char_136_hsguma', focus:-1});playground.Decision({options:[['1'], '交给我吧']});",
        "predicate = ['1'];",
        ...
        "playground.drawCharacter({name:'char_002_amiya_5', focus:-1});playground.Decision({options:[['1', '2', '3'], '你是在害怕吗？', '......难道说，你不喜欢这种力量？', '阿米娅，没有必要后悔。']});",
        "predicate = ['1'];",
        ...
        "predicate = ['1', '2', '3'];",
        "playground.drawCharacter({name:'char_002_amiya_4', focus:-1});playground.Decision({options:[['1'], '阿米娅，至少你保护了我。']});",
        "predicate = ['1'];",
