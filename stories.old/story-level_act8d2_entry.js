var story = [
    ...
    [
        ...
        "playground.clearDialog();playground.Decision({options:[['......（呵欠）']]});",
        "predicate = ['1'];",
        "playground.Decision({options:[['我想休息一下。', '接下来......']]});",
        "predicate = ['1'];",
        ...
        "playground.clearDialog();playground.Decision({options:[['哇，古代人怎么可能会这么懂？']]});",
        "predicate = ['1'];",
        ...
        "playground.clearDialog();playground.Decision({options:[['认真的吗？！']]});",
        "predicate = ['1'];",
        ...
        "playground.clearDialog();playground.Decision({options:[['......']]});",
        "predicate = ['1'];",
