var story = [
    ...
    [
        "playground.clearDialog();audio.playMusic({intro:'$darkness01_intro', key:'$darkness01_loop', volume:0.6, crossfade:1.5});delay(1);playground.clearDialog();playground.drawDialog({name:'？？？',text:'......'});",
        ...
        "playground.drawCharacter({});playground.clearDialog();delay(1.5);playground.clearDialog();audio.stopMusic({fadetime:1});audio.playSound({key:'$d_gen_walk_n'});delay(1);playground.drawDialog({name:'？？？',text:'......'});",
        ...
        "playground.drawCharacter({});playground.clearDialog();audio.playSound({key:'$d_gen_soldiersrun'});blocker.blocker({a:1, r:0, g:0, b:0, fadetime:2,block:true});background.showImage({image:'bg_county_1',fadetime:1});delay(1);playground.drawDialog({name:'',text:'晴 \\ 能见度 14公里'});",
        ...
        "audio.playSound({key:'$d_gen_soldiersrun'});playground.drawCharacter({});playground.clearDialog();blocker.blocker({a:1, r:0, g:0, b:0, fadetime:1,block:true});delay(1);blocker.blocker({a:0, r:0, g:0, b:0, fadetime:1, block:true});audio.playMusic({intro:'$m_dia_street_intro', key:'$m_dia_street_loop', volume:0.6,crossfade:1});playground.drawCharacter({name:'avg_npc_005'});playground.drawDialog({name:'村民',text:'————'});",
        ...
        "playground.drawCharacter({});playground.clearDialog();blocker.blocker({a:0, r:0, g:0, b:0, fadetime:1, block:true});audio.playSound({key:'$d_gen_walk_n'});playground.drawCharacter({name:'char_220_grani_3',fadetime:1});delay(1);playground.drawDialog({name:'格拉尼',text:'嘿~！'});",
        ...
        "audio.stopMusic({fadetime:1});playground.clearDialog();playground.drawCharacter({});delay(1);audio.playSound({key:'$d_gen_soldiersrun'});playground.drawDialog({name:'赏金猎人',text:'不行，找不到他们，给我从头再搜一遍！'});",
        "audio.playMusic({intro:'$indust_intro', key:'$indust_loop', volume:0.6, crossfade:1.5});playground.drawCharacter({name:'char_220_grani_5'});playground.drawDialog({name:'格拉尼',text:'继续待在这里不太安全，不能拖累这位大叔。'});",
